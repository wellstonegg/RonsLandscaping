...
class ContactUsMailerPreview < ActionMailer::Preview
  def contact_form_email
    contact_us_params = {name: 'Test User', email: 'test@test.com', phone: '9806543210',
...
Maecenas convallis lacus nec nibh accumsan commodo. In sagittis lorem nunc.'}.to_json
